            ...
            <div class="col-md">
                ...
                <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="detail" type="text" class="form-control @error('detail') is-invalid @enderror" name="detail" value="{{ $project->detail }}" required autocomplete="name" autofocus>
                ...
                <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="duration" type="text" class="form-control @error('duration') is-invalid @enderror" name="duration" value="{{ $project->duration }}" required autocomplete="name" autofocus>
                ...
                <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="revenue" type="text" class="form-control @error('revenue') is-invalid @enderror" name="revenue" value="{{ $project->revenue }}" required autocomplete="name" autofocus>
                ...
                <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Date_Start" type="date" class="form-control @error('start') is-invalid @enderror" name="start" value="{{ $project->start }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="end" type="date" class="form-control @error('end') is-invalid @enderror" name="end" value="{{ $project->end }}" required autocomplete="name" autofocus>
